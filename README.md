...
```javascript
iterMultiply = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-ops-multiply@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/math-iter-ops-multiply/tags). For example,

```javascript
iterMultiply = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-ops-multiply@v0.2.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var iterMultiply = require( 'path/to/vendor/umd/math-iter-ops-multiply/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-ops-multiply@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/math-iter-ops-multiply/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/math-iter-ops-multiply/actions/workflows/test.yml?query=branch:v0.2.0
...
[deno-readme]: https://github.com/stdlib-js/math-iter-ops-multiply/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/math-iter-ops-multiply/tree/umd
[umd-readme]: https://github.com/stdlib-js/math-iter-ops-multiply/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/math-iter-ops-multiply/tree/esm
[esm-readme]: https://github.com/stdlib-js/math-iter-ops-multiply/blob/esm/README.md
