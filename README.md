...
```javascript
iterMultiply = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-ops-multiply@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-ops-multiply@umd/bundle.js"></script>
```
...
<html lang="en">
<body>
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/simulate-iter-sine-wave@umd/bundle.js"></script>
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-ops-multiply@umd/bundle.js"></script>
<script type="text/javascript">
(function () {
